...
double clausiusclapyron_water_variable_L(double);
double clausiusclapyron_ice_constant_L(double);

double compute_cloud_watervapordensity(char *es, double z, Atmosphere *atm)
{
