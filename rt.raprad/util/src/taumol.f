C     path:      /home/kato/code/rrtm/SCCS/s.taumol.f
C     revision:  2.13
C     created:   04/16/98  16:36:26
C     presently: 05/21/98  13:25:28
*******************************************************************************
*                                                                             *
...
*******************************************************************************
      ...
      SUBROUTINE TAUGB1
     &    (ig, lay, jp, jt, jt1, nspa01, nspb01, laytrop,
...
c      COMMON /PROFILE/  NLAYERS,PAVEL(MXLAY),TAVEL(MXLAY),
c     &                  PZ(0:MXLAY),TZ(0:MXLAY)
c      COMMON /PROFDATA/ LAYTROP,LAYSWTCH,LAYLOW,
c     &                  COLH2O(MXLAY),COLCO2(MXLAY),
c     &                  COLO3(MXLAY),COLN2O(MXLAY),COLCH4(MXLAY),
c     &                  COLO2(MXLAY),CO2MULT(MXLAY)
c      COMMON /INTFAC/   FAC00(MXLAY),FAC01(MXLAY),                            
c     &                  FAC10(MXLAY),FAC11(MXLAY)                             
c      COMMON /INTIND/   JP(MXLAY),JT(MXLAY),JT1(MXLAY)
c      COMMON /SELF/     SELFFAC(MXLAY), SELFFRAC(MXLAY), INDSELF(MXLAY)
c      COMMON /FOREIGN/  FORFAC(MXLAY)
      COMMON /K1/       KA(5,13,MG), KB(5,13:59,MG) , SELFREF(10,MG)
c      COMMON /HVERSN/   HVRRTM,HVRREG,HVRRTR,HVRATM,HVRSET,HVRTAU,
c     *                  HVDUM1(4),HVRUTL,HVREXT
c
c      CHARACTER*8 HVRRTM,HVRREG,HVRRTR,HVRATM,HVRSET,HVRTAU,
c     *            HVDUM1,HVRUTL,HVREXT
c
...
c      DO 2500 LAY = 1, LAYTROP
      if (lay .le. laytrop) then

         IND0 = ((JP-1)*5+(JT-1))*NSPA01 + 1
         IND1 = (JP*5+(JT1-1))*NSPA01 + 1
         INDS = INDSELF
c         DO 2000 IG = 1, NG(1)
            TAUG = COLH2O *
     &          (FAC00 * ABSA(IND0,IG) +
     &           FAC10 * ABSA(IND0+1,IG) +
     &           FAC01 * ABSA(IND1,IG) + 
     &           FAC11 * ABSA(IND1+1,IG) +
     &           SELFFAC * (SELFREF(INDS,IG) + 
     &           SELFFRAC *
...
c      DO 3500 LAY = LAYTROP+1, NLAYERS
         IND0 = ((JP-13)*5+(JT-1))*NSPB01 + 1
         IND1 = ((JP-12)*5+(JT1-1))*NSPB01 + 1
c         DO 3000 IG = 1, NG(1)
            TAUG = COLH2O * 
     &          (FAC00 * ABSB(IND0,IG) +
     &           FAC10 * ABSB(IND0+1,IG) +
     &           FAC01 * ABSB(IND1,IG) + 
     &           FAC11 * ABSB(IND1+1,IG) + 
     &           FORFAC * FORREF(IG))
            FRACS = FRACREFB(IG)
c 3000    CONTINUE
c 3500 CONTINUE
...
C----------------------------------------------------------------------------
      ...
      SUBROUTINE TAUGB2
     &    (ig, lay, jp, jt, jt1, nspa02, nspb02, laytrop, 
     &     fac00, fac01, fac10, fac11,
...
C     BAND 2:  250-500 cm-1 (low - H2O; high - H2O)
      ...
      real*8 fac00, fac01, fac10, fac11, selffac, selffrac, forfac
      real*8 colh2o, coldry, taug, fracs
...
c      COMMON /PROFILE/  NLAYERS,PAVEL(MXLAY),TAVEL(MXLAY),
c     &                  PZ(0:MXLAY),TZ(0:MXLAY)
c      COMMON /SPECIES/  COLDRY(MXLAY),WKL(35,MXLAY),WBRODL(MXLAY),
c     &                  NMOL
c      COMMON /PROFDATA/ LAYTROP,LAYSWTCH,LAYLOW,
c     &                  COLH2O(MXLAY),COLCO2(MXLAY),
c     &                  COLO3(MXLAY),COLN2O(MXLAY),COLCH4(MXLAY),
...
c      COMMON /FOREIGN/  FORFAC(MXLAY)
      ...
      DIMENSION ABSA(65,MG),ABSB(235,MG),FORREF(MG)
c      DIMENSION FC00(MXLAY),FC01(MXLAY),FC10(MXLAY),FC11(MXLAY)
...
c      DO 2500 LAY = 1, LAYTROP
 ...
 1900    CONTINUE
     ...
     &        (REFPARAM(IFRAC-1)-REFPARAM(IFRAC))
         ...
         FC01 = FAC01 * CORR1 
         FC11 = FAC11 * CORR1 
         IND0 = ((JP-1)*5+(JT-1))*NSPA02 + 1
         IND1 = (JP*5+(JT1-1))*NSPA02 + 1
         INDS = INDSELF
c         DO 2000 IG = 1, NG(2)
            TAUG = COLH2O * 
     &          (FC00 * ABSA(IND0,IG) +
     ...
     &           (SELFREF(INDS+1,IG) - SELFREF(INDS,IG))) +
     &           FORFAC * FORREF(IG))
            FRACS = FRACREFA(IG,IFRAC) + FRACINT * 
...
c      DO 3500 LAY = LAYTROP+1, NLAYERS
         ...
         FC01 = FAC01 * CORR1
         FC11 = FAC11 * CORR1
         IND0 = ((JP-13)*5+(JT-1))*NSPB02 + 1
         IND1 = ((JP-12)*5+(JT1-1))*NSPB02 + 1
c         DO 3000 IG = 1, NG(2)
            TAUG = COLH2O * 
     &          (FC00 * ABSB(IND0,IG) +
     &           FC10 * ABSB(IND0+1,IG) +
...
C----------------------------------------------------------------------------
      ...
      SUBROUTINE TAUGB3
     &    (ig, lay, jp, jt, jt1, nspa03, nspb03, laytrop, 
     &     fac00, fac01, fac10, fac11,
...
C     BAND 3:  500-630 cm-1 (low - H2O,CO2; high - H2O,CO2)
      ...
      real*8 fac00, fac01, fac10, fac11, selffac, selffrac, forfac
      real*8 colh2o, colco2, coln2o, taug, fracs
...
C     From P = 64.1 mb.
     ...
     &     -1.26794E-04,-1.19011E-04,-2.67814E-04, 6.95005E-05/
      ...
      EQUIVALENCE (KA,ABSA),(KB,ABSB)
c      REAL KA,KB,N2OMULT,N2OREF  changed by s.k. 2/11/2002
      REAL KA,KB,N2OMULT
      STRRAT = 1.19268
      ONEMINUS = 1. - 1.E-6
...
c      DO 2500 LAY = 1, LAYTROP
      if (lay .le. laytrop) then
         ...
         FAC101 = FS * FAC01
         FAC111 = FS * FAC11
         IND0 = ((JP-1)*5+(JT-1))*NSPA03 + JS
         IND1 = (JP*5+(JT1-1))*NSPA03 + JS
         INDS = INDSELF
         COLREF1 = N2OREF(JP)
         COLREF2 = N2OREF(JP+1)
         IF (NS .EQ. 10) THEN
            ...
            WCOMB2 = H2OREF(JP+1)
         ELSE
            WCOMB1 = STRRAT * CO2REF(JP)/(1.-ETAREF(NS))
            WCOMB2 = STRRAT * CO2REF(JP+1)/(1.-ETAREF(NS))
         ENDIF
         RATIO = (COLREF1/WCOMB1)+FP*((COLREF2/WCOMB2)-(COLREF1/WCOMB1))
         CURRN2O = SPECCOMB * RATIO
         N2OMULT = COLN2O - CURRN2O 
c         DO 2000 IG = 1, NG(3)
            TAUG = SPECCOMB * 
     &          (FAC000 * ABSA(IND0,IG) +
...
c      DO 3500 LAY = LAYTROP+1, NLAYERS
         ...
         FAC101 = FS * FAC01
         FAC111 = FS * FAC11
         IND0 = ((JP-13)*5+(JT-1))*NSPB03 + JS
         IND1 = ((JP-12)*5+(JT1-1))*NSPB03 + JS
         COLREF1 = N2OREF(JP) 
         COLREF2 = N2OREF(JP+1) 
         IF (NS .EQ. 5) THEN
            WCOMB1 = H2OREF(JP)
...
c         DO 3000 IG = 1, NG(3)
     ...
     &           COLH2O * FORFAC * FORREF(IG) 
     &           + N2OMULT * ABSN2OB(IG)
            FRACS = FRACREFB(IG,JS) + FS *
...
C----------------------------------------------------------------------------
      ...
      SUBROUTINE TAUGB4
     &    (ig, lay, jp, jt, jt1, nspa04, nspb04, laytrop, 
     &     fac00, fac01, fac10, fac11,
...
C     BAND 4:  630-700 cm-1 (low - H2O,CO2; high - O3,CO2)
      ...
      real*8 fac00, fac01, fac10, fac11, selffac, selffrac, forfac
      real*8 colh2o, colco2, colo3, taug, fracs
...
c      DO 2500 LAY = 1, LAYTROP
      if (lay .le. laytrop) then
         ...
         SPECCOMB = COLH2O + STRRAT1*COLCO2
         SPECPARM = COLH2O/SPECCOMB 
         IF (SPECPARM .GE. ONEMINUS) SPECPARM = ONEMINUS
         SPECMULT = 8.*(SPECPARM)
         JS = 1 + INT(SPECMULT)
         ...
         FAC101 = FS * FAC01
         FAC111 = FS * FAC11
         IND0 = ((JP-1)*5+(JT-1))*NSPA04 + JS
         IND1 = (JP*5+(JT1-1))*NSPA04 + JS
         INDS = INDSELF
c         DO 2000 IG = 1, NG(4)
            TAUG = SPECCOMB * 
     &          (FAC000 * ABSA(IND0,IG) +
...
c      DO 3500 LAY = LAYTROP+1, NLAYERS
         ...
         FAC101 = FS * FAC01
         FAC111 = FS * FAC11
         IND0 = ((JP-13)*5+(JT-1))*NSPB04 + JS
         IND1 = ((JP-12)*5+(JT1-1))*NSPB04 + JS
c         DO 3000 IG = 1, NG(4)
            TAUG = SPECCOMB * 
     &          (FAC000 * ABSB(IND0,IG) +
     &           FAC100 * ABSB(IND0+1,IG) +
...
C----------------------------------------------------------------------------
      ...
      SUBROUTINE TAUGB5
     &    (ig, lay, jp, jt, jt1, nspa05, nspb05, laytrop, 
     &     fac00, fac01, fac10, fac11,
     &     indself, selffac, selffrac, forfac, colh2o, colco2, colo3,
     &     wx_1,
     &     taug, fracs)
...
C     BAND 5:  700-820 cm-1 (low - H2O,CO2; high - O3,CO2)
      ...
      real*8 fac00, fac01, fac10, fac11, selffac, selffrac, forfac
      real*8 colh2o, colco2, colo3, wx_1, taug, fracs
...
c     &                  COLO3(MXLAY),COLN2O(MXLAY),COLCH4(MXLAY),
c     &                  COLO2(MXLAY),CO2MULT(MXLAY)
c      COMMON /XSEC/     WX(MAXXSEC,MXLAY)
c      COMMON /INTFAC/   FAC00(MXLAY),FAC01(MXLAY),                            
c     &                  FAC10(MXLAY),FAC11(MXLAY)                             
c      COMMON /INTIND/   JP(MXLAY),JT(MXLAY),JT1(MXLAY)
c      COMMON /SELF/     SELFFAC(MXLAY), SELFFRAC(MXLAY), INDSELF(MXLAY)
...
c      DO 2500 LAY = 1, LAYTROP
      if (lay .le. laytrop) then
         ...
         FAC101 = FS * FAC01
         FAC111 = FS * FAC11
         IND0 = ((JP-1)*5+(JT-1))*NSPA05 + JS
         IND1 = (JP*5+(JT1-1))*NSPA05 + JS
         INDS = INDSELF
c         DO 2000 IG = 1, NG(5)
            TAUG = SPECCOMB * 
     &          (FAC000 * ABSA(IND0,IG) +
...
c      DO 3500 LAY = LAYTROP+1, NLAYERS
         ...
         FAC101 = FS * FAC01
         FAC111 = FS * FAC11
         IND0 = ((JP-13)*5+(JT-1))*NSPB05 + JS
         IND1 = ((JP-12)*5+(JT1-1))*NSPB05 + JS
c         DO 3000 IG = 1, NG(5)
            TAUG = SPECCOMB * 
     &          (FAC000 * ABSB(IND0,IG) +
     &           FAC100 * ABSB(IND0+1,IG) +
...
C----------------------------------------------------------------------------
      ...
      SUBROUTINE TAUGB6
     &    (ig, lay, jp, jt, jt1, nspa06, nspb06, laytrop, 
     &     fac00, fac01, fac10, fac11,
...
C     BAND 6:  820-980 cm-1 (low - H2O; high - nothing)
      ...
      real*8 fac00, fac01, fac10, fac11, selffac, selffrac, forfac
      real*8 colh2o, co2mult, wx_2, wx_3, taug, fracs
...
c      DO 2500 LAY = 1, LAYTROP
      if (lay .le. laytrop) then
         ...
         IND0 = ((JP-1)*5+(JT-1))*NSPA06 + 1
         IND1 = (JP*5+(JT1-1))*NSPA06 + 1
         INDS = INDSELF
c         DO 2000 IG = 1, NG(6)
            TAUG = COLH2O * 
     &          (FAC00 * ABSA(IND0,IG) +
...
C----------------------------------------------------------------------------
      ...
      SUBROUTINE TAUGB7
     &    (ig, lay, jp, jt, jt1, nspa07, nspb07, laytrop, 
     &     fac00, fac01, fac10, fac11,
...
C     BAND 7:  980-1080 cm-1 (low - H2O,O3; high - O3)
      ...
      real*8 fac00, fac01, fac10, fac11, selffac, selffrac, forfac
      real*8 colh2o, colo3, co2mult, taug, fracs
...
c      DO 2500 LAY = 1, LAYTROP
      if (lay .le. laytrop) then
         ...
         FAC101 = FS * FAC01
         FAC111 = FS * FAC11
         IND0 = ((JP-1)*5+(JT-1))*NSPA07 + JS
         IND1 = (JP*5+(JT1-1))*NSPA07 + JS
         INDS = INDSELF
c         DO 2000 IG = 1, NG(7)
            TAUG = SPECCOMB * 
     &          (FAC000 * ABSA(IND0,IG) +
...
c      DO 3500 LAY = LAYTROP+1, NLAYERS
         ...
         IND0 = ((JP-13)*5+(JT-1))*NSPB07 + 1
         IND1 = ((JP-12)*5+(JT1-1))*NSPB07 + 1
c         DO 3000 IG = 1, NG(7)
            TAUG = COLO3 *
     &          (FAC00 * ABSB(IND0,IG) +
     &           FAC10 * ABSB(IND0+1,IG) +
...
*******************************************************************************
      ...
      SUBROUTINE TAUGB8
     &    (ig, lay, jp, jt, jt1, nspa08, nspb08, laytrop, layswtch,
     &     fac00, fac01, fac10, fac11,
     &     indself, selffac, selffrac, forfac, colh2o, co2mult, 
     &     coln2o, colo3, wx_3, wx_4,
     &     taug, fracs)
...
C     BAND 8:  1080-1180 cm-1 (low (i.e.>~300mb) - H2O; high - O3)
      ...
      PARAMETER (MG=16, MXLAY=203, MAXXSEC=4, NBANDS=16)
      real*8 fac00, fac01, fac10, fac11, selffac, selffrac, forfac
      real*8 colh2o, co2mult, coln2o, colo3
      real*8 wx_3, wx_4, taug, fracs
...
C     and 1290-1335 cm-1 bands.
     ...
     &     1.95821E-07,1.98004E-07,2.06442E-07,2.81546E-07/
      ...
      EQUIVALENCE (KA,ABSA),(KB,ABSB)
c      REAL KA,KB,N2OMULT,N2OREF  change by s.k. 2/11/2002
      REAL KA,KB,N2OMULT


C     Compute the optical depth by interpolating in ln(pressure) and 
C     temperature.  
c      DO 2500 LAY = 1, LAYSWTCH
      if (lay .le. layswtch) then

         FP = FAC01 + FAC11
         IND0 = ((JP-1)*5+(JT-1))*NSPA08 + 1
         IND1 = (JP*5+(JT1-1))*NSPA08 + 1
         INDS = INDSELF
         COLREF1 = N2OREF(JP)
         COLREF2 = N2OREF(JP+1)
         WCOMB1 = H2OREF(JP)
...
c      DO 3500 LAY = LAYSWTCH+1, NLAYERS
      else

         FP = FAC01 + FAC11
         IND0 = ((JP-7)*5+(JT-1))*NSPB08 + 1
         IND1 = ((JP-6)*5+(JT1-1))*NSPB08 + 1
         COLREF1 = N2OREF(JP)
         COLREF2 = N2OREF(JP+1)
         WCOMB1 = O3REF(JP)
         WCOMB2 = O3REF(JP+1)
...
C----------------------------------------------------------------------------
      ...
      SUBROUTINE TAUGB9
     &    (ig, lay, jp, jt, jt1, nspa09, nspb09, 
     &     laytrop, layswtch, laylow,
     &     fac00, fac01, fac10, fac11,
     &     indself, selffac, selffrac, forfac, colh2o, colch4, coln2o,
     &     taug, fracs)
...
c      DO 2500 LAY = 1, LAYTROP
      if (lay .le. laytrop) then
         ...
         FAC101 = FS * FAC01
         FAC111 = FS * FAC11
         IND0 = ((JP-1)*5+(JT-1))*NSPA09 + JS
         IND1 = (JP*5+(JT1-1))*NSPA09 + JS
         INDS = INDSELF
c         IF (LAY .EQ. LAYLOW) IOFF = 16
c         IF (LAY .EQ. LAYSWTCH) IOFF = 32
         if (lay .ge. laylow) IOFF = 16
         if (lay .ge. layswtch) IOFF = 32
         COLREF1 = N2OREF(JP)
         COLREF2 = N2OREF(JP+1)
         IF (NS .EQ. 11) THEN
            WCOMB1 = H2OREF(JP)
            WCOMB2 = H2OREF(JP+1)
         ELSE
            WCOMB1 = STRRAT * CH4REF(JP)/(1.-ETAREF(NS))
            WCOMB2 = STRRAT * CH4REF(JP+1)/(1.-ETAREF(NS))
         ENDIF
         RATIO = (COLREF1/WCOMB1)+FP*((COLREF2/WCOMB2)-(COLREF1/WCOMB1))
         CURRN2O = SPECCOMB * RATIO
         N2OMULT = COLN2O - CURRN2O 
...
c      DO 3500 LAY = LAYTROP+1, NLAYERS
         ...
         IND0 = ((JP-13)*5+(JT-1))*NSPB09 + 1
         IND1 = ((JP-12)*5+(JT1-1))*NSPB09 + 1
c         DO 3000 IG = 1, NG(9)
            TAUG = COLCH4 *
     &          (FAC00 * ABSB(IND0,IG) +
     &           FAC10 * ABSB(IND0+1,IG) +
...
*******************************************************************************
      ...
      SUBROUTINE TAUGB10
     &    (ig, lay, jp, jt, jt1, nspa10, nspb10, 
     &     laytrop,
     &     fac00, fac01, fac10, fac11,
     &     indself, selffac, selffrac, forfac, colh2o,
     &     taug, fracs)
...
c      DO 2500 LAY = 1, LAYTROP
      if (lay .le. laytrop) then
         ...
         IND0 = ((JP-1)*5+(JT-1))*NSPA10 + 1
         IND1 = (JP*5+(JT1-1))*NSPA10 + 1
c         DO 2000 IG = 1, NG(10)
            TAUG = COLH2O *
     &          (FAC00 * ABSA(IND0,IG) +
     &           FAC10 * ABSA(IND0+1,IG) +
     &           FAC01 * ABSA(IND1,IG) + 
...
c      DO 3500 LAY = LAYTROP+1, NLAYERS
         ...
         IND0 = ((JP-13)*5+(JT-1))*NSPB10 + 1
         IND1 = ((JP-12)*5+(JT1-1))*NSPB10 + 1
c         DO 3000 IG = 1, NG(10)
            TAUG = COLH2O * 
     &          (FAC00 * ABSB(IND0,IG) +
     &           FAC10 * ABSB(IND0+1,IG) +
     &           FAC01 * ABSB(IND1,IG) + 
...
*******************************************************************************
      ...
      SUBROUTINE TAUGB11
     &    (ig, lay, jp, jt, jt1, nspa11, nspb11, 
     &     laytrop,
     &     fac00, fac01, fac10, fac11,
     &     indself, selffac, selffrac, forfac, colh2o,
     &     taug, fracs)
...
c      DO 2500 LAY = 1, LAYTROP
      if (lay .le. laytrop) then
         ...
         IND0 = ((JP-1)*5+(JT-1))*NSPA11 + 1
         IND1 = (JP*5+(JT1-1))*NSPA11 + 1
         INDS = INDSELF
c         DO 2000 IG = 1, NG(11)
            TAUG = COLH2O *
     &          (FAC00 * ABSA(IND0,IG) +
     &           FAC10 * ABSA(IND0+1,IG) +
     &           FAC01 * ABSA(IND1,IG) + 
...
c      DO 3500 LAY = LAYTROP+1, NLAYERS
         ...
         IND0 = ((JP-13)*5+(JT-1))*NSPB11 + 1
         IND1 = ((JP-12)*5+(JT1-1))*NSPB11 + 1
c         DO 3000 IG = 1, NG(11)
            TAUG = COLH2O * 
     &          (FAC00 * ABSB(IND0,IG) +
     &           FAC10 * ABSB(IND0+1,IG) +
     &           FAC01 * ABSB(IND1,IG) + 
...
C----------------------------------------------------------------------------
      ...
      SUBROUTINE TAUGB12
     &    (ig, lay, jp, jt, jt1, nspa12, nspb12, 
     &     laytrop,
     &     fac00, fac01, fac10, fac11,
...
C     BAND 12:  1800-2080 cm-1 (low - H2O,CO2; high - nothing)
      ...
      PARAMETER (MG=16, MXLAY=203, NBANDS=16)
      real*8 fac00, fac01, fac10, fac11, selffac, selffrac, forfac
      real*8 colh2o, colco2, taug, fracs
...
c      DO 2500 LAY = 1, LAYTROP
      if (lay .le. laytrop) then
         ...
         FAC101 = FS * FAC01
         FAC111 = FS * FAC11
         IND0 = ((JP-1)*5+(JT-1))*NSPA12 + JS
         IND1 = (JP*5+(JT1-1))*NSPA12 + JS
         INDS = INDSELF
c         DO 2000 IG = 1, NG(12)
            TAUG = SPECCOMB * 
     &          (FAC000 * ABSA(IND0,IG) +
     &           FAC100 * ABSA(IND0+1,IG) +
     &           FAC010 * ABSA(IND0+9,IG) +
...
C----------------------------------------------------------------------------
      ...
      SUBROUTINE TAUGB13
     &    (ig, lay, jp, jt, jt1, nspa13, nspb13, 
     &     laytrop,
     &     fac00, fac01, fac10, fac11,
...
C     BAND 13:  2080-2250 cm-1 (low - H2O,N2O; high - nothing)
      ...
      PARAMETER (MG=16, MXLAY=203, NBANDS=16)
      real*8 fac00, fac01, fac10, fac11, selffac, selffrac, forfac
      real*8 colh2o, coln2o, taug, fracs
...
c      DO 2500 LAY = 1, LAYTROP
      if (lay .le. laytrop) then
         ...
         SPECCOMB = COLH2O + STRRAT1*COLN2O
         SPECPARM = COLH2O/SPECCOMB 
         IF (SPECPARM .GE. ONEMINUS) SPECPARM = ONEMINUS
         SPECMULT = 8.*(SPECPARM)
         JS = 1 + INT(SPECMULT)
         ...
         FAC101 = FS * FAC01
         FAC111 = FS * FAC11
         IND0 = ((JP-1)*5+(JT-1))*NSPA13 + JS
         IND1 = (JP*5+(JT1-1))*NSPA13 + JS
         INDS = INDSELF
c         DO 2000 IG = 1, NG(13)
            TAUG = SPECCOMB * 
     &          (FAC000 * ABSA(IND0,IG) +
     &           FAC100 * ABSA(IND0+1,IG) +
     &           FAC010 * ABSA(IND0+9,IG) +
...
*******************************************************************************
      ...
      SUBROUTINE TAUGB14
     &    (ig, lay, jp, jt, jt1, nspa14, nspb14, 
     &     laytrop,
     &     fac00, fac01, fac10, fac11,
...
c      DO 2500 LAY = 1, LAYTROP
      if (lay .le. laytrop) then
         ...
         IND0 = ((JP-1)*5+(JT-1))*NSPA14 + 1
         IND1 = (JP*5+(JT1-1))*NSPA14 + 1
         INDS = INDSELF
c         DO 2000 IG = 1, NG(14)
            TAUG = COLCO2 *
     &          (FAC00 * ABSA(IND0,IG) +
     &           FAC10 * ABSA(IND0+1,IG) +
     &           FAC01 * ABSA(IND1,IG) + 
...
c      DO 3500 LAY = LAYTROP+1, NLAYERS
         IND0 = ((JP-13)*5+(JT-1))*NSPB14 + 1
         IND1 = ((JP-12)*5+(JT1-1))*NSPB14 + 1
c         DO 3000 IG = 1, NG(14)
            TAUG = COLCO2 * 
     &          (FAC00 * ABSB(IND0,IG) +
     &           FAC10 * ABSB(IND0+1,IG) +
     &           FAC01 * ABSB(IND1,IG) + 
...
C----------------------------------------------------------------------------
      ...
      SUBROUTINE TAUGB15
     &    (ig, lay, jp, jt, jt1, nspa15, nspb15, 
     &     laytrop,
     &     fac00, fac01, fac10, fac11,
...
c      DO 2500 LAY = 1, LAYTROP
      if (lay .le. laytrop) then
         ...
         SPECCOMB = COLN2O + STRRAT1*COLCO2
         ...
         FAC101 = FS * FAC01
         FAC111 = FS * FAC11
         IND0 = ((JP-1)*5+(JT-1))*NSPA15 + JS
         IND1 = (JP*5+(JT1-1))*NSPA15 + JS
         INDS = INDSELF
c         DO 2000 IG = 1, NG(15)
            TAUG = SPECCOMB * 
     &          (FAC000 * ABSA(IND0,IG) +
     &           FAC100 * ABSA(IND0+1,IG) +
     &           FAC010 * ABSA(IND0+9,IG) +
...
C----------------------------------------------------------------------------
      ...
      SUBROUTINE TAUGB16
     &    (ig, lay, jp, jt, jt1, nspa16, nspb16, 
     &     laytrop,
     &     fac00, fac01, fac10, fac11,
...
C     BAND 16:  2600-3000 cm-1 (low - H2O,CH4; high - nothing)
      ...
      PARAMETER (MG=16, MXLAY=203, NBANDS=16)
      real*8 fac00, fac01, fac10, fac11, selffac, selffrac, forfac
      real*8 colh2o, colch4, taug, fracs
...
c      DO 2500 LAY = 1, LAYTROP
      if (lay .le. laytrop) then
         ...
         SPECCOMB = COLH2O + STRRAT1*COLCH4
         SPECPARM = COLH2O/SPECCOMB 
         IF (SPECPARM .GE. ONEMINUS) SPECPARM = ONEMINUS
         SPECMULT = 8.*(SPECPARM)
         JS = 1 + INT(SPECMULT)
         ...
         FAC101 = FS * FAC01
         FAC111 = FS * FAC11
         IND0 = ((JP-1)*5+(JT-1))*NSPA16 + JS
         IND1 = (JP*5+(JT1-1))*NSPA16 + JS
         INDS = INDSELF
c         DO 2000 IG = 1, NG(16)
            TAUG = SPECCOMB * 
     &          (FAC000 * ABSA(IND0,IG) +
     &           FAC100 * ABSA(IND0+1,IG) +
     &           FAC010 * ABSA(IND0+9,IG) +
