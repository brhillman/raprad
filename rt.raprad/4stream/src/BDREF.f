...
c      REAL FUNCTION  BDREF( WVNMLO, WVNMHI, XMU, XMUP, DPHI, BDREF_F)

      subroutine  BDREF( WVNMLO, WVNMHI, XMU, XMUP, DPHI, BDREF_F )
...
c effective reflectance of the whitecaps (Koepke, 1984)
     ...
     &      0.8137348,0.8453338,0.8629867,0.8745421,0.9036854/
      ...
      mu = xmu
      mup = xmup
      if (XMUP .le. 0.026) MUP = 0.026
      if (XMU .le. 0.026) MU = 0.026
